...
@RestController
@RequestMapping("/v1/api/route-administration")
public class RouteAdministrationController {

    private CommonService service;

    public RouteAdministrationController(CommonMapper mapper, RouteAdministrationRepository repository) {
