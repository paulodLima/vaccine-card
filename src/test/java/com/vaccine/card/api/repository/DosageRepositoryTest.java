...
class DosageRepositoryTest {
    ...
    void findByUuid() {
        ...
        Optional<DosageEntity> byUuid = repository.findByUuid("45b7d9a5-c2f1-4332-9e4e-d11733f67ce0");

        assertTrue(byUuid.isPresent());

        DosageEntity diseaseEntity = byUuid.get();

        assertEquals(1L, diseaseEntity.getId());
        assertEquals("0,1 ml", diseaseEntity.getDescription());
    ...
    void findByUuidNotFound() {
        ...
        Optional<DosageEntity> byUuid = repository.findByUuid("45b7d9a5-c2f1-4332-9e4e-d11733f67c99");
