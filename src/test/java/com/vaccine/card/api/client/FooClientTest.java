package com.vaccine.card.api.client;

import com.vaccine.card.api.configuration.RestTemplateConfiguration;
import com.vaccine.card.api.dto.FooRequestDTO;
import com.vaccine.card.api.dto.FooResponseDTO;
import com.vaccine.card.api.exception.AbstractRuntimeException;
...
class FooClientTest {
    ...
    void insert() throws URISyntaxException {
        ...
        server.expect(ExpectedCount.once(),
                ...
                .andExpect(content().string("{\"id\":1233,\"name\":\"Foo name\",\"birthDate\":\"1999-05-22\",\"fooDate\":null,\"dtoList\":null,\"barDTO\":null}"))
